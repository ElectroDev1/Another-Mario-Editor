/// @description  scr_collision_rectangle_list(x1,y1,x2,y2,obj,prec,notme)
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param prec
/// @param notme
function scr_collision_rectangle_list(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	//
